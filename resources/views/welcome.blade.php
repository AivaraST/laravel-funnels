<x-layout.master>
  <x-pages.quiz.header />
  <main>
    <x-pages.quiz.question-single title="Single" subTitle="Single subtitle" key="single" :answers="[
        [
    ...
    <x-pages.quiz.question-single-manual title="Single manual" subTitle="Single manual subtitle" key="single-manual"
      :answers="[
          [
    ...
    <x-pages.quiz.question-multiple title="Multiple" subTitle="Multiple subtitle" key="multiple" :answers="[
        [
